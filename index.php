                ...
                <div class="panel-body">
                    ...
                    <form id="contact_form" method="Post" onsubmit="return Validate()" action="add.php" class="form-horizontal">
                        ...
                        <div class="form-group" id="username_div">
                             <label class="col-md-2 control-label" for="_name">Name</label>
                            <div class="col-md-4">
                         ...
                         <div class="form-group" id="cell_div">
                             <label class="col-md-2 control-label" for="cell_number">Cell Number</label>
                            <div class="col-md-4">
                         ...
                         <div class="form-group" id="work_div">
                             <label class="col-md-2 control-label" for="home_phone">Home Telephone</label>
                            <div class="col-md-4">
                         ...
                         <div class="form-group">
                             <label class="col-md-2 control-label" for="work_phone">Work Telephone</label>
                            <div class="col-md-4">
