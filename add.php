...
if (isset($_POST['add'])) {
    ...
    if ($results) {
        echo "<div class='row  text-center col-sm-offset-1'>
                  <strong class='container bg-danger'>successfully saved ".$name."</strong
                </div>";
    ...
    <body>
        ...
        <div class="container" >
                <div class="row col-sm-8 col-sm-offset-2">
                    <a href="index.php"  class="btn btn-primary col-lg-2"><span class="glyphicon glyphicon-plus"></span> New</a>
                    <h1 class="page-header text-center bg-danger row  col-sm-offset-1">Contact List</h1>
